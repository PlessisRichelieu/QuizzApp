...
public class HardMode extends AppCompatActivity {
    ...
    Questions [] questionBank = { new Questions(R.string.hQuestion1, R.string.hAnswer1_1, R.string.hAnswer1_2, R.string.hAnswer1_3, R.string.hAnswer1_4,3),
                                  new Questions(R.string.hQuestion2, R.string.hAnswer2_1, R.string.hAnswer2_2, R.string.hAnswer2_3, R.string.hAnswer2_4, 3),
                                  new Questions (R.string.hQuestion3, R.string.hAnswer3_1, R.string.hAnswer3_2, R.string.hAnswer3_3, R.string.hAnswer3_4,4 ),
                                  new Questions (R.string.hQuestion4, R.string.hAnswer4_1, R.string.hAnswer4_2, R.string.hAnswer4_3, R.string.hAnswer4_4,2 ),
                                  new Questions (R.string.hQuestion5, R.string.hAnswer5_1, R.string.hAnswer5_2, R.string.hAnswer5_3, R.string.hAnswer5_4, 2)
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Question = findViewById(R.id.hardQuestion);

        Answer1 = findViewById(R.id.hardAnswer1);

        Answer2 = findViewById(R.id.hardAnswer2);

        Answer3 = findViewById(R.id.hardAnswer3);

        Answer4 = findViewById(R.id.hardAnswer4);
